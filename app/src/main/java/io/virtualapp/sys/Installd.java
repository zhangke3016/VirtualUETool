...
public class Installd {
    ...
    public static void handleRequestFromFile(Activity activity, String path) {

        ArrayList<AppInfoLite> dataList = getAppInfoLiteFromPath(activity, path);
        if (dataList == null) {
            return;
        }
        startInstallerActivity(activity, dataList);
    }

    public static void startInstallerActivity(Activity activity, ArrayList<AppInfoLite> dataList) {
        if (activity == null) {
            return;
        }
