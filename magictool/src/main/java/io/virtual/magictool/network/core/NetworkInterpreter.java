package io.virtual.magictool.network.core;

import android.text.TextUtils;
import android.util.Log;
import io.virtual.magictool.network.bean.NetworkRecord;
import io.virtual.magictool.network.bean.Request;
import io.virtual.magictool.network.bean.Response;
import io.virtual.magictool.network.okhttp.NetworkManager;
import io.virtual.magictool.network.stream.InputStreamProxy;
import io.virtual.magictool.util.Utf8Charset;
...
public class NetworkInterpreter {
    ...
    public void responseReadFailed(int requestId, String s) {
        Log.i(TAG, "[responseReadFailed] requestId: " + requestId + " error: " + s);
    }
