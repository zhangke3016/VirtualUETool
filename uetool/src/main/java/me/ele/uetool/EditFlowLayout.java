...
public class EditFlowLayout extends CollectViewsLayout {
    ...
    public EditFlowLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public EditFlowLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
